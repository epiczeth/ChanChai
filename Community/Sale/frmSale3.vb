...
Public Class frmSale3
    ...
    Private Sub ShowMember()
        ...
        '    Exit Sub
        'End If
        'strSQL = "SELECT * FROM Member1 WHERE(M_ID = '" & txtM_ID.Text & "')"
        'da = New SqlDataAdapter(strSQL, Conn.getConnect())
    ...
    Private Sub ShowProduct()
        'strSQL = "SELECT * FROM Product2 WHERE(P_ID  = '" & txtP_ID.Text & "')"
        'da = New SqlDataAdapter(strSQL, Conn.getConnect())
        ...
        '    lblPrice.Text = CStr(ds.Tables("Product2").Rows(0).Item("Spe"))
    ...
    Private Sub ShowSale_Detail1()
        ...
        End If
    End Sub
    Private Sub frmSale3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub StringToPrint_Print(ByVal sender As Object, ByVal e As PrintPageEventArgs)
        ...
        'Else
        '    AnyString(e.Graphics, "ลูกค้า : " & lblMName.Text, 200, 180)
        'End If
    ...
    Private Sub load_cb()
        If cbpid.SelectedValue.ToString() <> "" Then
            ...
            While reader.Read()
                lblPrice.Text = reader.Item("Spe").ToString()
